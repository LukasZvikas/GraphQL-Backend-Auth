...
import { GraphQLSchema } from 'apollo-server-core/src/node_modules/graphql';
import { ApolloServerPlugin } from 'apollo-server-core/src/node_modules/apollo-server-plugin-base';
import { GraphQLServerOptions as GraphQLOptions } from 'apollo-server-core/src/graphqlOptions';
...
export declare class ApolloServerBase {
    ...
    executeOperation(request: GraphQLRequest): Promise<import("apollo-server-core/src/node_modules/graphql-extensions").GraphQLResponse>;
}
